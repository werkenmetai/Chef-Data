...
export function isEncrypted(value: string): boolean {
  // Encrypted tokens are base64 and have minimum length for salt + iv + data
  // Unencrypted tokens typically start with specific characters
...
/**
 * Generate a secure encryption key (for setup/documentation purposes)
